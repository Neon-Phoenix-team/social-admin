...
export const Search = ({ setSearchTerm, searchTerm }: searchType) => {
  ...
  return (
    <div className={s.wrapper}>
      <svg className={s.icon} xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
        <path
      ...
      <input value={inputValue} onChange={handleChange} className={s.input} type="text" name="" id=""
             placeholder={'Search'} />
    </div>
  )
}